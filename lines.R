...
py$ggplotly(bp, kwargs=list(fileopt='overwrite', filename='R-Cookbook/lines/basic horizontal line'))

# Make the line red and dashed
bp + geom_hline(aes(yintercept=12), colour="#990000", linetype="dashed")
py$ggplotly(bp, kwargs=list(fileopt='overwrite', filename='R-Cookbook/lines/dashed red line'))
