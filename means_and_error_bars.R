...
g <- ggplot(dfc, aes(x=dose, y=len, colour=supp)) +
    ...
    geom_line() +
    geom_point()
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/basic-error-bars'))
...
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/error-bars-dodged-position'))
...
g <- ggplot(dfc, aes(x=dose, y=len, colour=supp)) +
    ...
    geom_line(position=pd) +
    geom_point(position=pd)
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/error-bars-95%-confidence'))
...
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/black-error-bars'))
...
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/fully-styled-error-bars'))
...
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/bar-graph-with-error-bars'))
...
g <- ggplot(dfc2, aes(x=dose, y=len, fill=supp)) +
    ...
    geom_errorbar(aes(ymin=len-ci, ymax=len+ci),
                  width=.2,                    # Width of the error bars
                  position=position_dodge(.9))
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/bar-graph-with-95%-error-bars'))
...
g <- ggplot(dfc2, aes(x=dose, y=len, fill=supp)) +
    ...
    theme_bw()
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/bar-graph-with-error-bars-fully-styled'))
...
g <- ggplot(dfwc, aes(x=condition, y=value, group=1)) +
    ...
    ylim(40,60)
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/within-subject-error-bars'))
...
g <- ggplot(dfw.long, aes(x=condition, y=value, colour=subject, group=subject)) +
    ...
    ylim(ymin,ymax)
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/multiple-lines-1'))
...
g <- ggplot(dfwNorm.long, aes(x=condition, y=value_norm, colour=subject, group=subject)) +
    geom_line() + geom_point(shape=21, fill="white") +
    ylim(ymin,ymax)
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/multiple-lines-2'))
...
g <- ggplot(dfwc.between, aes(x=condition, y=value, group=1)) +
    ...
    geom_point(shape=21, size=3, fill="white") +
    ylim(ymin,ymax)
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/black-and-red-error-bars'))
...
py$ggplotly(g, kwargs=list(fileopt='overwrite', filename='R-Cookbook/means-and-error-bars/two-subject-error-bars'))
